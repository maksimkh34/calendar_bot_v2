...
async def start(update, context):
    await context.bot.send_message(
        ...
        text="Это бот-календарь. Он может планировать события, изменять уже запланированные и удалять их.\n"
             "Команды:\n"
             "/add - Добавить событие\n"
             "/check - Вывести все запланированные события\n"
             "/edit - Изменить текст события\n"
